...
(this, function (e, t) {
	...
	i.buildZone = function (e) {
		...
		s.forEach(function (e, o) {
			...
			e.forEach(function (e, o) {
				...
				var u = new t.Vector3(0, 0, 0);
				u.add(i.vertices[e.vertexIds[0]]),
				u.add(i.vertices[e.vertexIds[1]]),
				u.add(i.vertices[e.vertexIds[2]]),
				u.divideScalar(3),
	...
	h.prototype.getGroup = (a = new t.Plane, function (e, t, n) {
	...
	u = function (e) {
		function r() {
			var r = this;
			e.call(this),
			this._playerMarker = new t.Mesh(new t.SphereGeometry(.25, 32, 32), new t.MeshBasicMaterial({
						color: c.PLAYER
					})),
			...
			this._stepMarker = new t.Mesh(new t.BoxGeometry(.1, 1, .1), new t.MeshBasicMaterial({
						color: c.CLAMPED_STEP
					})),
			this._pathMarker = new e,
			this._pathLineMaterial = new t.LineBasicMaterial({
					color: c.PATH,
					linewidth: 2
				}),
			this._pathPointMaterial = new t.MeshBasicMaterial({
					color: c.WAYPOINT
				}),
			this._pathPointGeometry = new t.SphereBufferGeometry(.08),
		...
		r.prototype.setPath = function (e) {
			for (; this._pathMarker.children.length; )
				this._pathMarker.children[0].visible = !1, this._pathMarker.remove(this._pathMarker.children[0]);
			e = [this._playerMarker.position].concat(e);
			for (var r = new t.Geometry, n = 0; n < e.length; n++)
				r.vertices.push(e[n].clone().add(new t.Vector3(0, .2, 0)));
			this._pathMarker.add(new t.Line(r, this._pathLineMaterial));
			for (var o = 0; o < e.length - 1; o++) {
				var i = new t.Mesh(this._pathPointGeometry, this._pathPointMaterial);
				i.position.copy(e[o]),
				i.position.y += .2,
				this._pathMarker.add(i)
			}
			return this._pathMarker.visible = !0,
			this
		},
		r.prototype.setPlayerPosition = function (e) {
			return this._playerMarker.position.copy(e),
			this._playerMarker.visible = !0,
			this
		},
		r.prototype.setTargetPosition = function (e) {
			return this._targetMarker.position.copy(e),
			this._targetMarker.visible = !0,
			this
		},
		r.prototype.setNodePosition = function (e) {
			return this._nodeMarker.position.copy(e),
			this._nodeMarker.visible = !0,
			this
		},
		r.prototype.setStepPosition = function (e) {
			return this._stepMarker.position.copy(e),
