package laya.d3.math {
	...
	public class Collision {
		 ...
		 */
		public static function intersectsRayAndPlaneRD(ray:Ray, plane:Plane, out:Vector2):Boolean {
			...
			d = (-plane.distance - position) / direction;
			out.x = d;
			if (d < 0) {
				out.x = 0;
				return false;
		...
		public static function intersectsRayAndPlaneRP(ray:Ray, plane:Plane,out:Vector3):Boolean {
			...
			var distance:Vector2=new Vector2;
			...
			Vector3.scale(ray.direction, distance.x, _tempV30);
